...
public class RBTest {
    ...
    public static RBNode mkRedBlack(int... is) {
        RBNode current = new RBNil();
        for (int i : is) {
    ...
    public static String toString(RBNode n) {
    ...
    public static void main(String[] args) {
        RBNode tree = mkRedBlack(5, 7, 3, 1, 9, 4, 6, 11, 12, 13, 14, 15, 16, 17, 18);
