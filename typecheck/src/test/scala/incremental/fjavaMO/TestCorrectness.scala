...
//
  ...
  val E = ClassDec(Seq(CName('E), CName('Object), Ctor(ListMap(), ListMap()), Seq()), Seq(MethodDec(CName('Object), 'm, Seq('x -> CName('A)),Var('this)), MethodDec(CName('Object), 'm, Seq('x -> CName('B)),Var('this)),
    MethodDec(Seq(CName('Object), 'kot, Seq()), Seq(Invk(Seq('m), Seq( Var('this), New(Seq(CName('C)), Seq())))))))
//
//  val Prove = ClassDec(Seq(CName('Prove), CName('Object), Ctor(ListMap(), ListMap()), Seq()), Seq(MethodDec(Seq(CName('Object), 'kot, Seq()), Seq(Invk(Seq('m, New(CName('C))), Seq(Var('this)))))))
  ...
  val F = ClassDec(Seq(CName('F), CName('Object), Ctor(ListMap(), ListMap()), Seq()), Seq(MethodDec(CName('Object), 'm, Seq('x -> CName('A)),Var('this)), MethodDec(CName('Object), 'm, Seq('x -> CName('B)),Var('this)),
    MethodDec(CName('Object), 'm, Seq('x -> CName('D)),Var('this)), MethodDec(Seq(CName('Object), 'foo, Seq()), Seq(Invk(Seq('m), Seq( Var('this), New(Seq(CName('C)), Seq())))))))

  val AMOsup= ClassDec(Seq(CName('AMOsup), CName('Object), Ctor(ListMap(), ListMap()), Seq()), Seq(MethodDec(CName('Object), 'm, Seq('x -> CName('B)),Var('this)),
    MethodDec(CName('Object), 'm, Seq('x -> CName('D)),Var('this))))

  val BMOsub = ClassDec(Seq(CName('BMOsub), CName('AMOsup), Ctor(ListMap(), ListMap()), Seq()), Seq( MethodDec(Seq(CName('Object), 'foo, Seq()), Seq(Invk(Seq('m), Seq( Var('this), New(Seq(CName('C)), Seq())))))))

  typecheckTestFJ("supporting extends ", ProgramM(A, B, C, D,  AMOsup, BMOsub))(ProgramOK)
  ...
  val Amb = ClassDec(Seq(CName('Amb), CName('Object), Ctor(ListMap(), ListMap()), Seq()), Seq(MethodDec(CName('Object), 'm, Seq('x -> CName('String)),Var('this)),
    MethodDec(CName('Object), 'm, Seq('x -> CName('StringBuffer)),Var('this)), MethodDec(Seq(CName('Object), 'foo, Seq()), Seq(Invk(Seq('m), Seq( Var('this), New(Seq(CName('C)), Seq())))))))
...
//    MethodDec(CName('Object), 'm, Seq('x -> CName('D)),Var('this)), MethodDec(Seq(CName('Object), 'foo, Seq()), Seq(Invk(Seq('m), Seq( Var('this), New(Seq(CName('C)), Seq()))))),
//    MethodDec(Seq(CName('Object), 'bar, Seq()), Seq(Invk(Seq('m), Seq( Var('this), New(Seq(CName('C)), Seq())))))))
//
//
//  typecheckTestError("Wrong method merging", ProgramM(A, B, C, D, MWr))
  ...
  val Smpl  = ClassDec(Seq(CName('Smpl), CName('Object), Ctor(ListMap(), ListMap()), Seq()), Seq(MethodDec(Seq(CName('Object), 'm, Seq('x -> CName('A))),Seq(Var('this))), MethodDec(Seq(CName('Object), 'm, Seq('x -> CName('B))),Seq(Var('this))),
    MethodDec(Seq(CName('Object), 'foo, Seq()), Seq(Invk(Seq('m), Seq( Var('this), New(Seq(CName('C)), Seq())))))))

  typecheckTestFJ("Simple example of MO", ProgramM( A, B, C,  Smpl))(ProgramOK)
