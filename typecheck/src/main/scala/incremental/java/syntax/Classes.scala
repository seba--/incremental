...
case object FieldDec extends NodeKind_TMP[Result](_ => FieldDecSyntax) with NT_FieldDec

case object VarDec extends NodeKind_TMP[Result]((noKids andAlso lits(Seq(classOf[NT_VarDecId]))) orElse
...
abstract class FormalParam(syntaxcheck: SyntaxChecking.SyntaxCheck) extends NodeKind_TMP[Result](syntaxcheck)
...
case object EnumDec extends NodeKind_TMP[Result](noLits andAlso unsafeKids(Seq(classOf[NT_EnumDecHead], classOf[NT_EnumBody]))) with NT_EnumDec

case object EnumDecHead extends NodeKind_TMP[Result]((litsFollowedBy(classOf[ClassMod], classOf[String]) orElse litsFollowedBy(classOf[ClassMod], Seq(classOf[String], classOf[Interfaces])))
                                         andAlso unsafeAllKids(classOf[NT_Anno])) with NT_EnumDecHead

case object EnumBody extends NodeKind_TMP[Result]((noLits andAlso unsafeAllKids(classOf[NT_EnumConst])) orElse
                                      (noLits andAlso uKidsFollowedBy(classOf[NT_EnumConst], classOf[NT_EnumBodyDecs]))) with NT_EnumBody
case object EnumConst extends NodeKind_TMP[Result](simple(Seq(classOf[String])) orElse
...
case object EnumBodyDecs extends NodeKind_TMP[Result](unsafeAllKids(classOf[NT_ClassBodyDec])) with NT_EnumBodyDecs
...
case object ConstrDec extends NodeKind_TMP[Result](noLits andAlso unsafeKids(Seq(classOf[NT_ConstrHead], classOf[NT_ConstrBody]))) with NT_ConstrDec
case object ConstrDecHead extends NodeKind_TMP[Result]((litsFollowedBy(classOf[ConstrMod], classOf[String]) orElse
...
case object ConstrBody extends NodeKind_TMP[Result](uFollowedByKids(classOf[NT_ConstrInv], classOf[NT_BlockStm])) with NT_ConstrBody
case object AltConstrInv extends NodeKind_TMP[Result]((noLits orElse lits(Seq(classOf[TypeArgs]))) andAlso allKids(cExpr)) with NT_ConstrInv
case object SuperConstrInv extends NodeKind_TMP[Result]((noLits orElse lits(Seq(classOf[TypeArgs]))) andAlso allKids(cExpr)) with NT_ConstrInv
case object QSuperConstrInv extends NodeKind_TMP[Result]((noLits orElse lits(Seq(classOf[TypeArgs]))) andAlso allKids(cExpr) andAlso nonEmptyKids) with NT_ConstrInv

// StaticInitializers
trait NT_StaticInit extends NT_ClassBodyDec
case object StaticInit extends NodeKind_TMP[Result](simple(Block.getClass)) with NT_StaticInit

// InstanceInitializers
trait NT_InstanceInit extends NT_ClassBodyDec
case object InstanceInit extends NodeKind_TMP[Result](simple(Block.getClass)) with NT_InstanceInit

// MethodDeclarations
trait NT_MethodDec extends NT_ClassMemberDec
trait NT_MethodDecHead

case object MethodDec extends NodeKind_TMP[Result](noLits andAlso unsafeKids(Seq(classOf[NT_MethodDecHead], classOf[NT_MethodBody]))) with NT_MethodDec
case object MethodDecHead extends NodeKind_TMP[Result]((litsFollowedBy(classOf[MethodMod], Seq(classOf[ResultType], classOf[String])) orElse
...
case object DeprMethodDecHead extends NodeKind_TMP[Result](simple()) with NT_MethodDecHead // TODO: ( Anno | MethodMod )* TypeParams? ResultType Id "(" {FormalParam ","}* ")" Dim+ Throws?

trait NT_MethodBody
case object NoMethodBody extends NodeKind_TMP[Result](simple()) with NT_MethodBody
...
case object ClassDec extends NodeKind_TMP[Result](noLits andAlso unsafeKids(Seq(classOf[NT_ClassDecHead], classOf[NT_ClassBody]))) with NT_ClassDec
case object ClassBody extends NodeKind_TMP[Result](noLits andAlso unsafeAllKids(classOf[NT_ClassBodyDec])) with NT_ClassBody
case object ClassDecHead extends NodeKind_TMP[Result](unsafeAllKids(classOf[NT_Anno]) andAlso
